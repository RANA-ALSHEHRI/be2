...
class LoginComScreen extends StatelessWidget {
  // This widget is the root of your application.
  static const String idScreen = 'LoginComScreen';
                      ...
                      onPressed: () {
                        if (emailF.text.length < 4) {
                          ...
                          authenticateUser(context);
                                        ...
                                        Navigator.pushNamedAndRemoveUntil(context, NavCompanion.idScreen, (route) => false);
 },
                    ),
                  ],
                ),
...
//reference Firebase.Auth.FirebaseAuth objects to manage user accounts.
  ...
  void authenticateUser(BuildContext context) async {
    ...
    if (firebaseUser != null) {
      ...
      companionUserRef.child(firebaseUser.uid).once().then((DataSnapshot snap) {
        if (snap.value != null) {
          // main screen family
          Navigator.pushNamedAndRemoveUntil(
